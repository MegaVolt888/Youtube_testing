...
import static com.github.axet.vget.vhs.YouTubeInfo.YoutubeQuality.p480;
...
public class AppManagedDownload {
    ...
    public static void main(String[] args) {
        ...
        String url = "https://www.youtube.com/watch?v=HwhMyGUGxZ0";
        //String url = args[0];
        // ex: /Users/axet/Downloads/
       // File path = new File(args[1]);
        File path = new File("D:/Temp/YT/");
        ...
        try {
            ...
            if (list != null) {
                for (VideoFileInfo d : list) {
                    ...
                    System.out.println("Download URL: " + d.getSource()  + " "+ d.getContentType() );
                }
            }
